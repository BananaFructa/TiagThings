        ...
        try {
            ...
            if (this.world.isRemote) {
                ...
                if (this.currentTask != null) {
                    clientTick.invoke(this,this.currentTask);
                }
                ...
                if (this.firstChecked.get()) {
                    ...
                    for (int i = 0; i < maxTasks; ++i) {
                        if (this.currentTask != null) {
                            long needed = (long)getRequiredPowerThisTick.invoke(this,this.currentTask);
                            ...
                            if (!(Boolean)addPower.invoke(this,this.currentTask,added)) {
                                sendUpdate = true;
                                break;
                            }
