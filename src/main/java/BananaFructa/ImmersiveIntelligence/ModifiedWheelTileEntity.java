...
public class ModifiedWheelTileEntity extends TileEntityMechanicalWheel implements ITBlockInterfaces.IMechanicalEnergy {

    //boolean isFeeding = false;
    BlockPos feedingTo = new BlockPos(0,0,0);

    public ModifiedWheelTileEntity() {
        super();
    }

    public ModifiedWheelTileEntity(EnumFacing facing) {
        this.facing = facing;
    }
