...
public class ModifiedWheelTileEntityIron extends TileEntityWheelIron implements ITBlockInterfaces.IMechanicalEnergy {
    //boolean isFeeding = false;
    BlockPos feedingTo = new BlockPos(0,0,0);

    public ModifiedWheelTileEntityIron() {
        super();
    }

    public ModifiedWheelTileEntityIron(EnumFacing facing) {
        this.facing = facing;
    }
