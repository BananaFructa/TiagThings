...
public class ContainerMagnetizer extends ContainerIEBase<TileEntityMagnetizer> {

    TileEntityMagnetizer tile;
    EntityPlayer player;
    public ContainerMagnetizer(InventoryPlayer inventoryPlayer, TileEntityMagnetizer tile) {
        ...
        this.addSlotToContainer(new Slot(tile.inventoryHandlers.get(0),0,43,33){
            @Override
            public boolean isItemValid(ItemStack stack) {
                return inventory.isItemValidForSlot(slotNumber,stack);
            }
        });
        this.addSlotToContainer(new Slot(tile.inventoryHandlers.get(1),0,116,33){
            @Override
            public boolean isItemValid(ItemStack stack) {
                return false;
            }
