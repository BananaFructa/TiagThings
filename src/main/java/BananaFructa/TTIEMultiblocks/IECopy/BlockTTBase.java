...
public abstract class BlockTTBase<E extends Enum<E> & BlockTTBase.IBlockEnum> extends Block implements IIEMetaBlock {
...
//		ImmersiveEngineering.registerBlockByFullName(this, itemBlock, registryName);
        TTIEContent.registeredTTBlocks.add(this);
        try{
            TTIEContent.registeredTTItems.add(itemBlock.getConstructor(Block.class).newInstance(this).setRegistryName(name));
            //TTIEContent.registeredTTItems.add(itemBlock.getConstructor(Block.class).newInstance(this));
    ...
    public BlockTTBase setMetaHidden(int... meta)
    {
        for(int i : meta)
    ...
    public BlockTTBase setMetaUnhidden(int... meta)
    {
        for(int i : meta)
            if(i>=0 && i<this.isMetaHidden.length)
    ...
    public BlockTTBase setHasFlavour(int... meta)
    {
    ...
    public BlockTTBase<E> setBlockLayer(BlockRenderLayer... layer)
    {
        this.renderLayers = Sets.newHashSet(layer);
        return this;
    }
    public BlockTTBase<E> setMetaBlockLayer(int meta, BlockRenderLayer... layer)
    {
    ...
    public BlockTTBase<E> setMetaLightOpacity(int meta, int opacity)
    {
    ...
    public BlockTTBase<E> setMetaHardness(int meta, float hardness)
    {
    ...
    public BlockTTBase<E> setMetaExplosionResistance(int meta, int resistance)
    {
    ...
    public BlockTTBase<E> setMetaMobilityFlag(int meta, EnumPushReaction flag)
    {
    ...
    public BlockTTBase<E> setNotNormalBlock(int meta)
    {
    ...
    public BlockTTBase<E> setAllNotNormalBlock()
    {
        if(metaNotNormalBlock == null)
            metaNotNormalBlock = new boolean[this.enumValues.length];
    ...
    public BlockTTBase<E> setMetaHammerHarvest(int meta)
    {
        canHammerHarvest[meta] = true;
        return this;
    }
    public BlockTTBase<E> setHammerHarvest()
    {
        for(int i = 0; i < metaNotNormalBlock.length; i++)
    ...
    public BlockTTBase<E> setOpaque(boolean isOpaque)
    {
        opaqueCube = isOpaque;
        fullBlock = isOpaque;
        return this;
