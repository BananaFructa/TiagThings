...
public class TransactionalTEConnectorMV extends TileEntityConnectorMV implements NetworkElement {
    ...
    public Vec3d getConnectionOffset(ImmersiveNetHandler.Connection con) {
        ...
        return new Vec3d((double)0.5F + (double)side.getFrontOffsetX() * ((double)0.0625F - conRadius), (double)0.5F + (double)side.getFrontOffsetY() * ((double)0.0625F - conRadius), (double)0.5F + (double)side.getFrontOffsetZ() * ((double)0.0625F - conRadius));
    }
