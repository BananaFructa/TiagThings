...
public class TileEntityCoalBoiler extends SimplifiedTileEntityMultiblockMetal<TileEntityCoalBoiler, SimplifiedMultiblockRecipe> {
    ...
    public static final SimplifiedMultiblockRecipe coalBurnRecipe1 = new SimplifiedMultiblockRecipe(new ItemStack[]{Utils.itemStackFromCTId("<tiagthings:bituminous_coal_powder>")},new FluidStack[0],new ItemStack[0],new FluidStack[0],1024,20 * 60 * 4,true);
    public static final SimplifiedMultiblockRecipe coalBurnRecipe2 = new SimplifiedMultiblockRecipe(new ItemStack[]{Utils.itemStackFromCTId("<tiagthings:lignite_powder>")},new FluidStack[0],new ItemStack[0],new FluidStack[0],1024,20 * 60 * 2,true);
    public static final SimplifiedMultiblockRecipe coalBurnRecipe3 = new SimplifiedMultiblockRecipe(new ItemStack[]{Utils.itemStackFromCTId("<tiagthings:jet_powder>")},new FluidStack[0],new ItemStack[0],new FluidStack[0],1024,20 * 40,true);
    public static final SimplifiedMultiblockRecipe coalBurnRecipe4 = new SimplifiedMultiblockRecipe(new ItemStack[]{Utils.itemStackFromCTId("<tiagthings:coke_powder>")},new FluidStack[0],new ItemStack[0],new FluidStack[0],1024,20 * 60,true);
    public static final SimplifiedMultiblockRecipe coalBurnRecipe5 = new SimplifiedMultiblockRecipe(new ItemStack[]{Utils.itemStackFromCTId("<tfc:powder/charcoal>")},new FluidStack[0],new ItemStack[0],new FluidStack[0],1024,20 * 60 * 2,true);
