...
public class TileEntityCoalBoiler extends SimplifiedTileEntityMultiblockMetal<TileEntityCoalBoiler, SimplifiedMultiblockRecipe> {
    ...
    public static final SimplifiedMultiblockRecipe coalBurnRecipe1 = new SimplifiedMultiblockRecipe(new ItemStack[]{Utils.itemStackFromCTId("<tfc:ore/bituminous_coal>")},new FluidStack[0],new ItemStack[0],new FluidStack[0],4096,20 * 60 * 4);
    public static final SimplifiedMultiblockRecipe coalBurnRecipe2 = new SimplifiedMultiblockRecipe(new ItemStack[]{Utils.itemStackFromCTId("<tfc:ore/lignite>")},new FluidStack[0],new ItemStack[0],new FluidStack[0],4096,20 * 60 * 2);
    public static final SimplifiedMultiblockRecipe coalBurnRecipe3 = new SimplifiedMultiblockRecipe(new ItemStack[]{Utils.itemStackFromCTId("<tfc:ore/jet>")},new FluidStack[0],new ItemStack[0],new FluidStack[0],4096,20 * 40);
    public static final SimplifiedMultiblockRecipe coalBurnRecipe4 = new SimplifiedMultiblockRecipe(new ItemStack[]{Utils.itemStackFromCTId("<tfc:powder/coke>")},new FluidStack[0],new ItemStack[0],new FluidStack[0],4096,20 * 40);
    public static final SimplifiedMultiblockRecipe coalBurnRecipe5 = new SimplifiedMultiblockRecipe(new ItemStack[]{Utils.itemStackFromCTId("<minecraft:coal:1>")},new FluidStack[0],new ItemStack[0],new FluidStack[0],4096,20 * 60 * 2);
