...
sandbox = {
  ...
  utf8 = utf8 and {
    ...
    research = {
        test = research.test,
        begin = research.begin,
        finish = research.finish,
        --perform = function()
            ...
            --return research.finish()
        --end,
        check = research.check,
        merge = research.merge,
        costOf = research.costOf,
        acquire = research.acquire,
        descriptionOf = research.descriptionOf,
        nameOf = research.nameOf,
        meetsRequirements = research.meetsRequirements,
        idOf = research.idOf,
        give = research.give
  },
